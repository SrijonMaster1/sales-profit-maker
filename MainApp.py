...
import SalesProfitEstimator as optim
...
def build_banner():
    return html.Div(
        ...
        className='banner',
        children=[
            html.Img(src=app.get_asset_url('profitestimatorlogo.png'),style={'display':'inline-block','height':'20%','width':'20%'}),
            html.H4('This is an Unique opportunity to Maximize your Gain and Minimize financial Loss.',style={'color':'orange','display':'inline-block'})
        ]
    )
...
def file_download_link(filename):
    ...
    return html.A("Sales data file: "+filename, href=location)
...
def update_output(uploaded_filenames, uploaded_file_contents):
    ...
    if len(files) == 0:
        ...
        final_price_list, profit_wo_price_change_effect, profit_with_price_change_effect, change_in_total_price, perc_lift_in_profit, perc_change_in_price, change_in_total_units_sold, perc_change_in_sales = optim.findMaximumProfit(
            csv_files_path)
        ...
        html.P(id='original_profit',children=dash_text2,style={'font-weight':'bold'}),
        html.P(id='price_change',children=dash_text3),
        html.P(id='volume_change', children=dash_text4),
        html.H2("Estimated Price and Profit details:",style={'color':'blue'}),
...
app.layout = html.Div(children=[
    ...
    html.H2("Upload Sales Data:",style={'color':'blue'}),
    dcc.Upload(
        id="upload-data",
        children=html.Div(
    ...
    html.H2("Profit Summary:",style={'color':'blue'}),
